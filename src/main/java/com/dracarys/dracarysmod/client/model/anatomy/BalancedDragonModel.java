...
/**
 * BALANCED — Step 5.9 organic voxel anatomical reconstruction.
 *
...
public final class BalancedDragonModel<T extends DracarysDragonEntity>
    ...
    /* ====================================================================== */
    /* NECK + HEAD — fifteen visual masses, compact skull, anterolateral eyes   */
    /* ====================================================================== */
    ...
    private static void createHead(PartDefinition head) {
        /*
         * STEP 5.9: smaller draconic skull. The old head had crocodilian length
         * and mass; this version keeps a compact braincase, tapered wedge snout,
         * lateral eyes and a crown that visually flows into the neck.
         */
        addEllipsoidMass(head, "occipital_mass", 6.8F, 4.7F, 8.6F,
                0.0F, -0.45F, 2.0F, -0.055F, 0, 218);
        addEllipsoidMass(head, "temporal_mass", 6.3F, 4.2F, 7.8F,
                0.0F, -0.35F, -2.9F, -0.040F, 34, 218);
        addEllipsoidMass(head, "orbital_cranium", 5.9F, 3.7F, 7.4F,
                0.0F, -0.15F, -7.4F, -0.020F, 68, 218);
        addEllipsoidMass(head, "snout_root", 4.8F, 2.85F, 7.2F,
                0.0F, 0.30F, -11.8F, 0.025F, 100, 218);
        addEllipsoidMass(head, "snout_mid", 3.9F, 2.25F, 6.5F,
                0.0F, 0.52F, -16.1F, 0.022F, 130, 218);
        addEllipsoidMass(head, "muzzle", 3.1F, 1.75F, 5.5F,
                0.0F, 0.66F, -20.0F, 0.018F, 160, 218);
        addEllipsoidMass(head, "nose_bridge", 2.45F, 1.35F, 4.0F,
                0.0F, 0.70F, -23.2F, 0.012F, 188, 218);

        for (boolean left : new boolean[]{true, false}) {
            float side = left ? 1.0F : -1.0F;
            String q = left ? "left" : "right";
            addSideMass(head, q + "_jaw_adductor", left, 4.7F, 5.8F, 7.8F,
                    side * 4.8F, 0.9F, -4.2F, 0.03F, side * -0.13F, side * -0.12F, 0, 236);
            addSideMass(head, q + "_cheek_mass", left, 4.0F, 4.7F, 6.8F,
                    side * 4.9F, 1.3F, -8.4F, 0.03F, side * -0.14F, side * -0.11F, 28, 236);

            head.addOrReplaceChild(
                    q + "_eye_orbit",
                    builder(58, 236, left)
                            .addBox(-1.35F, -1.10F, -1.55F, 2.70F, 2.20F, 3.10F),
                    PartPose.offsetAndRotation(side * 5.65F, -2.10F, -8.2F,
                            -0.065F, side * -0.25F, side * -0.13F)
            );
            head.addOrReplaceChild(
                    q + "_eye",
                    builder(76, 236, left)
                            .addBox(-0.52F, -0.50F, -0.62F, 1.04F, 1.00F, 1.24F),
                    PartPose.offsetAndRotation(side * 6.48F, -2.08F, -8.9F,
                            -0.025F, side * -0.31F, 0.0F)
            );
            head.addOrReplaceChild(
                    q + "_brow_ridge",
                    builder(88, 236, left)
                            .addBox(-2.65F, -0.68F, -2.85F, 5.30F, 1.36F, 5.70F),
                    PartPose.offsetAndRotation(side * 3.7F, -3.55F, -8.3F,
                            -0.18F, side * -0.15F, side * -0.15F)
            );
        ...
        PartDefinition jaw = head.addOrReplaceChild(
                ...
                PartPose.offsetAndRotation(0.0F, 3.0F, -7.2F, 0.01F, 0.0F, 0.0F)
        );
        addEllipsoidMass(jaw, "jaw_hinge_mass", 5.2F, 2.25F, 7.5F,
                0.0F, 0.35F, 0.2F, -0.020F, 110, 236);
        addEllipsoidMass(jaw, "jaw_body", 4.4F, 1.80F, 8.8F,
                0.0F, 0.30F, -4.5F, -0.018F, 142, 236);
        addEllipsoidMass(jaw, "jaw_mid", 3.6F, 1.45F, 7.7F,
                0.0F, 0.25F, -9.6F, -0.025F, 174, 236);
        addEllipsoidMass(jaw, "jaw_tip", 2.7F, 1.05F, 5.3F,
                0.0F, 0.20F, -13.9F, -0.038F, 204, 236);
    ...
    private static void createHorn(PartDefinition head, boolean left, boolean primary) {
        float side = left ? 1.0F : -1.0F;
        float len1 = primary ? 8.2F : 5.5F;
        float thick = primary ? 2.15F : 1.55F;
        String name = (left ? "left" : "right") + (primary ? "_horn" : "_horn_secondary");
        PartDefinition horn = head.addOrReplaceChild(
                name,
                builder(primary ? 108 : 134, 246, left)
                        .addBox(-thick * 0.5F, -thick * 0.5F, -0.7F, thick, thick, len1),
                PartPose.offsetAndRotation(side * (primary ? 4.6F : 5.0F),
                        primary ? -3.5F : -2.8F,
                        primary ? 1.7F : -3.0F,
                        primary ? -0.58F : -0.42F,
                        side * (primary ? 0.44F : 0.56F),
                        side * -0.13F)
        );
        float t2 = thick * 0.50F;
        PartDefinition tip = horn.addOrReplaceChild(
                "tip",
                builder(primary ? 150 : 168, 246, left)
                        .addBox(-t2 * 0.5F, -t2 * 0.5F, 0.0F, t2, t2, len1 * 0.64F),
                PartPose.offsetAndRotation(0.0F, 0.0F, len1 - 0.8F,
                        -0.28F, side * 0.13F, side * -0.06F)
        );
        float t3 = Math.max(0.40F, t2 * 0.52F);
        tip.addOrReplaceChild(
                "needle",
                builder(primary ? 188 : 202, 246, left)
                        .addBox(-t3 * 0.5F, -t3 * 0.5F, 0.0F, t3, t3, len1 * 0.35F),
                PartPose.offsetAndRotation(0.0F, 0.0F, len1 * 0.58F,
                        -0.20F, side * 0.08F, 0.0F)
        );
    }
    ...
    private static void createHeadCrown(PartDefinition head) {
        float[] z = {3.0F, 0.2F, -2.6F, -5.4F, -8.2F, -11.0F, -13.7F};
        float[] h = {6.8F, 7.2F, 6.8F, 6.0F, 5.1F, 4.1F, 3.1F};
        for (int i = 0; i < z.length; i++) {
            head.addOrReplaceChild(
                    "crown_spine_" + (i + 1),
                    CubeListBuilder.create().texOffs(18 + i * 15, 246)
                            .addBox(-0.52F, -h[i], -0.85F, 1.04F, h[i], 1.70F),
                    PartPose.offsetAndRotation(0.0F, -3.25F + i * 0.10F, z[i],
                            -0.36F, 0.0F, (i % 2 == 0 ? 0.025F : -0.025F))
            );
        }
    }
    ...
    private static void createCheekSpikes(PartDefinition head, boolean left) {
        ...
        String q = left ? "left" : "right";
        for (int i = 0; i < 3; i++) {
            float len = 4.6F - i * 0.7F;
            head.addOrReplaceChild(
                    q + "_cheek_spike_" + (i + 1),
                    builder((112 + i * 12) % 224, 246, left)
                            .addBox(-0.38F, -0.38F, 0.0F, 0.76F, 0.76F, len),
                    PartPose.offsetAndRotation(side * (5.2F - i * 0.18F), 1.1F + i * 0.55F, -5.4F - i * 2.2F,
                            0.18F, side * (0.72F + i * 0.06F), side * -0.13F)
            );
        }
    }
    ...
    private static void createFacialScales(PartDefinition head) {
        for (boolean left : new boolean[]{true, false}) {
            ...
            String q = left ? "l" : "r";
            for (int i = 0; i < 5; i++) {
                float w = 2.3F - i * 0.18F;
                head.addOrReplaceChild(
                        q + "_face_scale_" + (i + 1),
                        builder((i * 18) % 220, 232, left)
                                .addBox(-w * 0.5F, -0.24F, -1.15F, w, 0.48F, 2.30F),
                        PartPose.offsetAndRotation(side * (5.4F - i * 0.22F), -0.4F + i * 0.32F, -3.2F - i * 3.1F,
                                -0.05F, side * -0.10F, side * (0.22F - i * 0.025F))
                );
            }
        }
    }
