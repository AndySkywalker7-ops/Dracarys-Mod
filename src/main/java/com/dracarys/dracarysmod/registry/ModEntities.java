...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<DracarysDragonEntity>> DRAGON=ENTITIES.register("dracarys_dragon",()->EntityType.Builder.of(DracarysDragonEntity::new, MobCategory.CREATURE).sized(2.4f,2.0f).clientTrackingRange(32).updateInterval(2).build("dracarys_dragon"));
    private ModEntities(){}
}
